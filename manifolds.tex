...
\begin{corollary}
	A surface of constant Gauss curvature admits local curvature line coordinates such that for a suitable function $\omega$
...
\begin{proof}
	...
	Then $\abs{\xi^\pm}^2=1$ and $\s \xi^\pi \perp \xi^\pm$, cause
	...
	Hence there exists a $X: V \to M$ local parametrisation such tthat $\xi^+ \circ X = \p Xu$ and $\xi^- \circ X = \p Xv$.
\end{proof}
