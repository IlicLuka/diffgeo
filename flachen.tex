...
\begin{definition}
	...
	\begin{itemize}
		...
		\item \emph{parabolischer Punkt} (parabolic point), falls nur ein $\kappa^\pm(u,v)=0$ ist.
...
\begin{proof}
	...
	Da die Gauß-Krümmung eine geometrischen Invariante ist -- $ \widetilde{K} = K \circ (u,v) $ für eine Umparametrisierung $ \widetilde{X}=X \circ(u,v) $ -- muss notwendigerweise $ K \equiv 0, $ falls eine isometrische Parametrisierung existiert.	
\end{proof}
